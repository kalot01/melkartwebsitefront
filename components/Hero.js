...
function Hero() {
  ...
  return (
    <div className='hero-container'>
      ...
      <h1 className="text-center">Trading legacy carried by youth</h1>
      
      <button type="button" className="btn-h from-left" data-toggle="modal" data-target="#exampleModal">Démarrez un projet avec nous</button>
